...
install_wukong() {
    ...
    arch="$(uname -m)"
    url="https://github.com/YuXilong/cocoapods-publish/releases/download/v2.2.0/wukong_arm64_2.1.9"
    if [ "${arch}" == "x86_64" ]; then
    url="https://github.com/YuXilong/cocoapods-publish/releases/download/v2.2.0/wukong_i386_2.1.9"
    fi
